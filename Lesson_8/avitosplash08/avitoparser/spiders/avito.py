...
class AvitoSpider(scrapy.Spider):
    ...
    # start_urls = [f"https://www.avito.ru/volgograd?q=%D0%BA%D0%BE%D1%82%D1%8F%D1%82%D0%B0"]

    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.page = 1
        self.start_urls = [f"https://www.avito.ru/volgograd?p={self.page}&q={kwargs.get('request')}"]
